...
# union or min
_C.DATASETS.POST_PROCESS.FINAL_NMS_MODE = 'union'
...
# Region size for wsi test
_C.DATASETS.CLUSTER_PARAMETER.REGION_SIZE = (1000,1000)
...
_C.DATASETS.CLUSTER_PARAMETER.PRIOR_MODE = "assign" # assign or bbox
_C.DATASETS.CLUSTER_PARAMETER.WSI_PRIOR = None
_C.DATASETS.CLUSTER_PARAMETER.CANVAS_SIZE = (-1,-1)
_C.DATASETS.CLUSTER_PARAMETER.MAX_CHILD_SIZE = [0,0] # only be used in 2 stage baseline
_C.DATASETS.CLUSTER_PARAMETER.PRIOR_LEVEL = (100,100)
_C.DATASETS.CLUSTER_PARAMETER.ROI_THRESHOLD = 0.1
_C.DATASETS.CLUSTER_PARAMETER.PACK_MODE = "resize" # crop or resize
_C.DATASETS.CLUSTER_PARAMETER.REGION_MODE = "heatmap"
_C.DATASETS.CLUSTER_PARAMETER.REGION = []
_C.DATASETS.CLUSTER_PARAMETER.REGION_FILE = []
_C.DATASETS.CLUSTER_PARAMETER.REGION_LEVEL = 1
_C.DATASETS.CLUSTER_PARAMETER.SELECTION_RATIO = 1.0
_C.DATASETS.CLUSTER_PARAMETER.NMM_CLUSTER_THR = []
_C.DATASETS.CLUSTER_PARAMETER.MAX_CLUSTER_SIZE = [0,0]
