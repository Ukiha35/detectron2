...
if __name__ == '__main__':
    ...
    args.output_config = "/home/ps/ltc/detectron2/configs/PascalVOC-Detection/faster_rcnn_X_101_FPN.yaml"
    args.model_weights_pth = "/home/ps/ltc/detectron2/experiments/DHB/model_final.pth"
    args.conf_threshold = 0.05
    args.final_nms_switch = True
    args.img_size = 1000
    args.stride_proportion = 0.25
    args.save_path = "/home/ps/ltc/detectron2/experiments_output/DHB_fullres_test"
    args.test_kfb_path = "/media/ps/passport1/ltc/DHB/test/"
    args.GPU = '0'
    
    os.environ["CUDA_VISIBLE_DEVICES"] = args.GPU
    
    if not os.path.exists(os.path.basename(args.output_config)):
        os.makedirs(os.path.basename(args.output_config))
    ...
    FINAL_NMS_THRESH_DICT = {"particle":0.1}
    ...
    CONF_THRESH_DICT = {"particle":0.05}
    ...
    img_num_count = 0
    process_num = 1 # suggest it equal to gpu_num  
